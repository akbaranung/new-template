  ...
  <div class="wrapper vh-100">
    <div class="align-items-center h-100 d-flex w-50 mx-auto">
      <div class="mx-auto text-center">
        ...
        <h1 class="display-1 m-0 font-weight-bolder text-muted" style="font-size:80px;"><?= $heading ?></h1>
        <h6 class="mb-3 text-muted"><?= $message ?></h6>
        <a href="<?= site_url('/') ?>" class="btn btn-lg btn-primary px-5">Back to Dashboard</a>
      </div>
    </div>
  </div>
