		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
			...
			<div class="card shadow mb-4">
				<div class="card-body">
					<div class="row mb-3">
						<div class="col-12">
							<form method="POST" action="<?= base_url('financial/bukubesar') ?>">
								<div class="d-flex flex-wrap align-items-center justify-content-end">
									...
									<div class="form-group mb-2">
										...
										<!-- <button class="btn btn-info text-white" data-toggle="modal" data-target="#reportBBMonthly" type="button">
                                            Per bulan
                                        </button> -->
										<a href="<?= base_url('financial/bukubesarMonthly') ?>" class="btn btn-info text-white" target="_blank">Per bulan</a>
									</div>
								</div>
							</form>
						</div>
						...
						<table id="" class="table table-sm table-striped table-bordered" style="width:100%">
							...
							if ($list_coa) {
								foreach ($list_coa as $lc) :
									...
									if ($transaction) {
										$has_transaction = true; // Set flag jadi true kalau ada transaksi
							?>
										<thead class="thead-dark">
											<tr class="headings">
												<th style="width: 15%"><?= $lc->no_sbb ?></th>
												<th style="width: 40%"><?= strtoupper($lc->nama_perkiraan) ?></th>
												<th class="text-right" colspan="3"><?= $this->session->userdata('kode_cabang') ?></th>
											</tr>
										</thead>
										<tbody>
											<tr>
										...
										<tr>
											<td colspan="5" class="text-center py-4">
												<div class="alert alert-info mb-0">
													<i class="fa fa-info-circle"></i> Belum ada transaksi tercatat untuk tahun <?= $per_tahun ?>
												</div>
											</td>
										</tr>
									</tbody>
