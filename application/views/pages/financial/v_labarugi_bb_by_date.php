<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
      <h1 class="page-title">Neraca Buku Besar</h1>
        ...
        <div class="card-body">
          <form method="POST" action="<?= base_url('financial/reportByDate') ?>">
            <div class="row">
              <div class="col-md-4 col-xs-12">
                <h5>
                  Laba Berjalan : <strong><?= (isset($total_pendapatan)) ? rupiah($total_pendapatan) : 0 ?></strong>
                </h5>
              </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-xs-12">
              ...
              <p class="text-right">Total: <strong><?= (isset($sum_biaya)) ? rupiah($sum_biaya) : 0 ?></strong></p>
            ...
            <div class="col-md-6 col-xs-12">
              ...
              <p class="text-right">Total: <strong><?= (isset($sum_pendapatan)) ? rupiah($sum_pendapatan) : 0 ?></strong></p>
              <div class="table-responsive">
                <table class="table table-sm" style="width:100%">
                  <thead class="thead-dark">
                    <tr>
