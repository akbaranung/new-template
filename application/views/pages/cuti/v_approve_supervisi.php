<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
            <h1 class="page-title">Data Approval Supervisi</h1>
            <div class="card shadow mb-4">
                ...
                <div class="card-body" id="all">
                    <div class="table-responsive">
                        <table id="table-approve-supervisi" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr class="headings">
...
<div class="modal fade" id="modal-update-cuti-hrd">
    <div class="modal-dialog modal-centered">
        <div class="modal-content">
            ...
            <!--body-->
            <div class="modal-body">
                <!-- <form action="<?= base_url('cuti/update_cuti_supervisi/') ?>" id="form-update-cuti-hrd" method="post">
                    <div class="form-group">
