...
<form id="formCOA">
	<div class="alert alert-info">
		...
		COA Persediaan otomatis diambil dari master item masing-masing.<br>
		Pilih akun <strong><?= $metode_bayar == 'cash' ? 'Kas' : 'Utang Dagang' ?></strong> untuk pencatatan jurnal input stok ini.
	</div>
	...
	<div class="card bg-light">
		<div class="card-body">
			...
			<table class="table table-sm table-bordered mb-0">
				...
				<tbody>
					<tr>
						<td>Persediaan Barang <small class="text-muted">(per item, otomatis)</small></td>
