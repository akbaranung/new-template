				...
				<div class="card-body" id="user">
					<font style="font-size:14px;">
                      ...
                      <img class="border border-primary" src="<?= ($perusahaan->logo) ? $perusahaan->logo : $utility['logo']; ?>" alt="logo" style="width: 200px">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Header Invoice (opsional)</label>
										<div class="d-flex justify-content-center">
											<textarea class="form-control is-readonly" name="header_invoice" id="header_invoice" rows="5" readonly><?= $perusahaan->header_invoice ?></textarea>
											<button type="button" class="btn btn-secondary btns-edit" data-target="header_invoice"><i class="fe fe-edit-2"></i></button>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group ">
										...
										<div class="d-flex justify-content-center">
											...
											<select class="form-control form-select" name="coa_ppn_keluaran" id="coa_ppn_Keluaran">
												<!-- <option value="default">20301 :: PPN KELUARAN :: Default</option> -->
											</select>
										</div>
									</div>
								</div>
