    ...
    <li class="nav-item">
      <a href="#" onclick="upgrade_premium()" data-is-premium="<?= (int)($this->session->userdata('is_premium') == '1'); ?>" class="my-2 btn btn-<?= ($this->session->userdata('is_premium') == '1') ? 'primary' : 'pink' ?>">
        <?= ($this->session->userdata('is_premium') == '1') ?
          ...
          :
          '<b><span class="desktop-only">Become the</span> King!</b> <img src="' . base_url() . 'assets/icons/sword_white.png" alt="Sword Icon" width="16" height="16" style="vertical-align: middle; margin-left: 5px;">'
        ?>
      </a>
    </li>
    <li class="nav-item">
