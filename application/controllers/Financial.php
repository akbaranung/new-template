    ...
    if ($this->session->userdata('is_premium')) {
      ...
      if ($jenis) {
        $this->session->set_flashdata('swal_message', [
          ...
          'text' => 'Kekuasaan untuk menambah dan mengelola semua user di tangan Anda! Tingkatkan akun Anda sekarang untuk membuka potensi penuh dan mengklaim takhta Anda..',
